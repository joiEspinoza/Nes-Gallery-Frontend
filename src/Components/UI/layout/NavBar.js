                   ...
                   { 
                    ...
                    {   
                        ...
                        <table>
                            <tbody>
                                <tr>    
                                    <td><button onClick={ handleRedirectHome } className="btn btn-outline-secondary navBar__btnLogin base__btnGallery" type="button"><i className="fas fa-backward"></i></button></td>
                                </tr>
                            </tbody>
                        </table>
                    }
